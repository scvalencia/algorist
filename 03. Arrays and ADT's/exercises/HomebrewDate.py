class HomebrewDate(object):
	...
	def next(self):
		if self.valid(self.month, self.day + 1, self.year):
			return HomebrewDate(self.month, self.day + 1, self.year)
		elif self.valid(self.month + 1, 1, self.year):
			return HomebrewDate(self.month + 1, 1, self.year)
		else:
			return HomebrewDate(1, 1, self.year + 1)
	...
	def day_of_year(self):
		init = HomebrewDate(1, 1, self.year)
	...
	def print_calendar(self):
		...
		init = HomebrewDate(date.month, 1, year)
